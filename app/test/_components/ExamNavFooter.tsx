...
export default function ExamNavFooter({ currentIdx, total, onPrev, onNext, onSubmit, isSubmitting }: ExamNavFooterProps) {
  ...
  return (
    <div className="border-t border-sand-border bg-card px-8 py-4 flex justify-between items-center shrink-0">
      <button
        onClick={onPrev}
        disabled={currentIdx === 0}
        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl
                   border border-sand-border bg-card text-[14px] font-medium
